...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
    ...
    # value='all_values', 
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000,
                                    marks={0: '0',2500: '2,500',5000: '5,000',7500: '7,500',10000: '10,000'},value=[0, 10000]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        pie_df = filtered_df.groupby(["Launch Site"]).size().reset_index(name='counts')
        fig = px.pie(pie_df, values='counts', 
        names='Launch Site', 
        ...
        pie_df = filtered_df.groupby(["Launch Site","class"]).size().reset_index(name='counts')
        fig = px.pie(pie_df, values='counts', 
        names='class', 
...
def get_scatter_chart(entered_site,payload_mass):
    ...
    if entered_site == 'ALL':
        filtered_df = filtered_df.loc[(filtered_df['Payload Mass (kg)'] >= payload_mass[0]) & 
